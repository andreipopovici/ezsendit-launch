...
var fnames = new Array();var ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='SUGGESTION';ftypes[3]='text';
try {
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://andreipopovici.us2.list-manage.com/subscribe/post-json?u=026407352bb2450819c3ac8ed&id=2ae92998a9&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
...
$(function()
{
	...
	if($.cookie(postId) == 'true') {
		...
		// your server would take care of the proper pushes count, but because this is a
		// static page, we need to set it here so it doesn't become -1 when you remove
		// the pushes after a reload
		$(".num").html(17);
	}	
	...
	$("figure.push").bind("push:removed", function(e)
	{
		var element = $(this);
		// ajax'y stuff or whatever you want
